...
def SetEnvVars():
    ...
    if 'ROS_PACKAGE_PATH' not in os.environ:
        os.environ['ROS_PACKAGE_PATH'] = ROS_WORKSPACE + '/src:/opt/ros/indigo/share:/opt/ros/indigo/stacks'
    ...
    os.environ['PYTHONPATH'] = ROS_WORKSPACE + '/devel/lib/python2.7/dist-packages:/opt/ros/indigo/lib/python2.7/dist-packages' + (os.environ['PYTHONPATH'] if 'PYTHONPATH' in os.environ else '')
